 ...
 */
public class AGTGenDefaultTestAction implements IObjectActionDelegate {
	
	private static final String ACTION_ID = "lazy.test.plugin.popmenu.extend.action.method.default";
	...
	public void run(IAction action) {
        ...
        try {
            ...
            AGTDefaultShowVO detailShowVO = WizardVOConvertProcessor.parseAGTDefaultShowVO(context, selection);
            context.setVo(detailShowVO);

            WizardDialog dialog = WizardDialogGenProcessor.genDefaultWizardDialog(context, workbench);
            ...
            if (Boolean.valueOf(MessageConfigHandler.findMappingResult(AGTCommonProperties.PROJECT_CONFIG_WHITEBOX))) {
            	...
            	dialog.setMinimumPageSize(100, 480);
            }
