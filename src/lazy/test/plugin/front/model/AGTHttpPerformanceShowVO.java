 ...
 */
public class AGTHttpPerformanceShowVO extends AGTAbstractShowVO {
    ...
    protected boolean validSpecial() {
        return StringUtils.isNotBlank(genHttpUrl) && StringUtils.startsWith(genHttpUrl, "http")
    ...
    public String toString() {
        return "AGTHttpPerformanceShowVO{" +
